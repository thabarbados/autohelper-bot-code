export const botTexts = Object.freeze({
  ...
  addTextDescriptionNote:
    'Введи описание необходимого и отправь его мне',
  ...
  unexpectedTextWithButton: 'Сейчас не нужно ничего вводить, выбери подходящий вариант ниже. Если дополнительная клавиатура отсутствует - нажми на иконку 🔠 в строке ввода.',
  unexpectedTextWithChooseFile: 'Сейчас не нужно ничего вводить, нажми на 📎 и выбери фото.',
  unexpectedTextWithBotAnswer: 'Сейчас не нужно ничего вводить, дождись ответа от бота.',
  confirmOrderTitle: 'Отлично, ты почти сделал заказ. Давай проверим корректность введенных данных.',
  confirmOrderNotice: 'Подтверди введенные данные или выбери что нужно изменить:',
  ...
  stopCreateOrdersNotice: 'Напоминаю, что ты всегда можешь сделать новый заказ с выбрав команду /start'
});
